...
> End-to-End DevSecOps pipeline using Docker, Jenkins, GitHub Actions and AWS.
...
A vulnerable Node.js application built for learning Web Security.
...
Python-based plagiarism detector.
